...
class BaseEvento:
    ...
    def _criar_evento_exclusao(self, nome_base, dir_anterior):
        metadados_anteriores = self.obter_metadados_arquivo_excluido(nome_base)

        tipo_arquivo = None

        if metadados_anteriores:
            return {
                "tipo_operacao": self.observador.loc.get_text("op_deleted"),
                "nome": nome_base,
                "dir_anterior": dir_anterior,
                "dir_atual": "",
                "data_criacao": metadados_anteriores.get("data_criacao", ""),
                "data_modificacao": metadados_anteriores.get("data_modificacao", ""),
                "data_acesso": metadados_anteriores.get("data_acesso", ""),
                "tipo": metadados_anteriores.get("tipo", ""),
                "tamanho": metadados_anteriores.get("tamanho", ""),
                "atributos": metadados_anteriores.get("atributos", ""),
                "autor": metadados_anteriores.get("autor", ""),
                "dimensoes": metadados_anteriores.get("dimensoes", ""),
                "duracao": metadados_anteriores.get("duracao", ""),
                "taxa_bits": metadados_anteriores.get("taxa_bits", ""),
                "protegido": metadados_anteriores.get("protegido", "")
            }
